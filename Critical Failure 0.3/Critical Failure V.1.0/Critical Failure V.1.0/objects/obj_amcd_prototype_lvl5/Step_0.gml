...
if global.current_zone = global.prototypelvl5pos+1{ 
...
if jump_scare_timer = 0{
	...
	if global.prototypelvl5pos = 7 and global.door_right_open{
	alarm[1] = 2
	}
	if global.prototypelvl5pos = 7 and !global.door_right_open{
		alarm[6] = 2;
	...
	if global.prototypelvl5pos = 2 and global.door_left_open{
	alarm[1] = 2
	}
	if global.prototypelvl5pos = 7 and !global.door_left_open{
		alarm[6] = 2;
	alarm[3] = 2
	jump_scare_timer = 500
	killstate = false
