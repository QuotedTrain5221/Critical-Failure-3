...
if  global.gwiberlvl5pos = 1 { //cam 1
    alarm[0] = 2;
		...
		if instance_exists(obj_cam_zone_5_prototype_k9){
			instance_create_layer(obj_cam_zone_5_prototype_k9.x,obj_cam_zone_5_prototype_k9.y,"Instances",obj_cam_zone_5_proto_k9_gwib) 
		...
		if instance_exists(obj_cam_zone_1_prototype_gwiber){
			instance_create_layer(obj_cam_zone_1_prototype_gwiber.x,obj_cam_zone_1_prototype_gwiber.y,"Instances",obj_cam_zone_1_prototype) 
		instance_destroy(obj_cam_zone_1_prototype_gwiber)
		}
		if instance_exists(obj_cam_zone_1_proto_k9_gwib){
			instance_create_layer(obj_cam_zone_1_proto_k9_gwib.x,obj_cam_zone_1_proto_k9_gwib.y,"Instances",obj_cam_zone_1_prototype_k9) 
		...
		instance_create_layer(obj_cam_zone_2_prototype_k9.x,obj_cam_zone_2_prototype_k9.y,"Instances",obj_cam_zone_2_proto_k9_gwib)
...
if global.gwiberlvl5pos = 3 { //cam 3
	...
	if !forward and pickedadirection{
		...
		instance_create_layer(obj_cam_zone_3_prototype_gwiber.x,obj_cam_zone_3_prototype_gwiber.y,"Instances",obj_cam_zone_3_prototype)
...
if global.gwiberlvl5pos = 4 { //cam 4
	...
	if forward and pickedadirection {
		...
		if instance_exists(obj_cam_zone_4_prototype_gwiber){
			instance_create_layer(obj_cam_zone_4_prototype_gwiber.x,obj_cam_zone_4_prototype_gwiber.y,"Instances",obj_cam_zone_4_prototype) 
	...
	if global.door_left_open{
	  ...
	  global.gwiberkillstate = true
	   ...
	   if !global.door_left_open{
		   ...
		   alarm[4] = 2;
	   global.gwiberlvl5pos = choose(1,3)
	   pickedadirection = false
	   ...
	   if instance_exists(obj_cam_zone_1_k9){
		...
		instance_create_layer(obj_cam_zone_1_prototype_k9.x,obj_cam_zone_1_prototype_k9.y,"Instances",obj_cam_zone_1_proto_k9_gwib)
		...
		if instance_exists(obj_cam_zone_2_prototype_gwiber){
			instance_create_layer(obj_cam_zone_2_prototype_gwiber.x,obj_cam_zone_2_prototype_gwiber.y,"Instances",obj_cam_zone_2_prototype) 
	   ...
	   if global.gwiberlvl5pos = 3{
		...
		if instance_exists(obj_cam_zone_2_proto_k9_gwib){
			instance_create_layer(obj_cam_zone_2_proto_k9_gwib.x,obj_cam_zone_2_proto_k9_gwib.y,"Instances",obj_cam_zone_2_prototype_k9) 
...
// Zone 5 move options
   ...
   if global.gwiberlvl5pos = 5 { //cam 5
	...
	if instance_exists(obj_cam_zone_1_prototype_k9){
		...
		instance_create_layer(obj_cam_zone_5_gwiber.x,obj_cam_zone_5_gwiber.y,"Instances",obj_cam_zone_5_lvl5)
		instance_destroy(obj_cam_zone_5_gwiber)}
		
		if instance_exists(obj_cam_zone_5_prototype_gwiber){
		instance_create_layer(obj_cam_zone_5_prototype_gwiber.x,obj_cam_zone_5_prototype_gwiber.y,"Instances",obj_cam_zone_5_prototype)
		instance_destroy(obj_cam_zone_5_gwiber)}
		
	if instance_exists(obj_cam_zone_5_proto_k9_gwib){
		instance_create_layer(obj_cam_zone_5_proto_k9_gwib.x,obj_cam_zone_5_proto_k9_gwib.y,"Instances",obj_cam_zone_5_prototype_k9)
	...
	if forward and pickedadirection {
		...
		instance_destroy(obj_cam_zone_13_gwiber)}
			...
			if instance_exists(obj_cam_zone_13_prototype_gwiber){
			instance_create_layer(obj_cam_zone_13_prototype_gwiber.x,obj_cam_zone_13_prototype_gwiber.y,"Instances",obj_cam_zone_13_prototype) 
		instance_destroy(obj_cam_zone_13_prototype_gwiber)}
		}
   ...
   if global.gwiberlvl5pos = 17 { //cam 17
	...
	if forward and pickedadirection {
		...
		if instance_exists(obj_cam_zone_17_gwiber){
			instance_create_layer(obj_cam_zone_17_gwiber.x,obj_cam_zone_17_gwiber.y,"Instances",obj_cam_zone_17_lvl5) 
		instance_destroy(obj_cam_zone_17_gwiber)
		}
		
		if instance_exists(obj_cam_zone_17_prototype_gwiber){
			instance_create_layer(obj_cam_zone_17_prototype_gwiber.x,obj_cam_zone_17_prototype_gwiber.y,"Instances",obj_cam_zone_17_prototype) 
		instance_destroy(obj_cam_zone_17_prototype_gwiber)
		}
   ...
   if	global.gwiberlvl5pos = 12 { //cam 12
	...
	if forward and pickedadirection {
		...
		if instance_exists(obj_cam_zone_12_prototype_gwiber){
			instance_create_layer(obj_cam_zone_12_prototype_gwiber.x,obj_cam_zone_12_prototype_gwiber.y,"Instances",obj_cam_zone_12_prototype) 
		instance_destroy(obj_cam_zone_12_prototype_gwiber)}
		}
   ...
   if global.gwiberlvl5pos = 16 { //cam 16
	...
	if forward and pickedadirection {
		...
		if instance_exists(obj_cam_zone_16_prototype_gwiber){
			instance_create_layer(obj_cam_zone_16_prototype_gwiber.x,obj_cam_zone_16_prototype_gwiber.y,"Instances",obj_cam_zone_16_prototype) 
		instance_destroy(obj_cam_zone_16_prototype_gwiber)
		}
