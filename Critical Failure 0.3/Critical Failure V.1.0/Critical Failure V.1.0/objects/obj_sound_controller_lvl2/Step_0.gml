...
if global.gwiberlvl2pos = 2 or global.k9lvl2pos = 2 {lefthallway = true}
if global.k9lvl2pos = 7 {righthallway = true}
...
if global.k9footstep_cam1lvl2 = true{
...
if audioplaytimerleft <= 0 {
  ...
  global.k9footstep_cam1lvl2 = false
  }}
  
  if global.k9footstep_cam2lvl2 = true{
 if audioplaytimerleft = 150{
  audio_play_sound(snd_k9_footsteps,1,false)}
  audioplaytimerleft -= 1
...
if audioplaytimerleft <= 0 {
  audio_stop_sound(snd_k9_footsteps)
  global.k9footstep_cam2lvl2 = false
  }}

if global.k9footstep_cam6lvl2 = true{
 if audioplaytimerleft = 150{
  audio_play_sound(snd_k9_footsteps,1,false)}
  audioplaytimerleft -= 1
...
if audioplaytimerleft <= 0 {
  audio_stop_sound(snd_k9_footsteps)
  global.k9footstep_cam6lvl2 = false
  }}
  
  if global.k9footstep_cam7lvl2 = true{
 if audioplaytimerleft = 150{
  audio_play_sound(snd_k9_footsteps,1,false)}
  audioplaytimerleft -= 1
...
if audioplaytimerleft <= 0 {
  audio_stop_sound(snd_k9_footsteps)
  global.k9footstep_cam7lvl2 = false
  }}
  
  if global.k9footstep_cam5lvl2 = true{
 if audioplaytimerleft = 150{
  audio_play_sound(snd_k9_footsteps,1,false)}
  audioplaytimerleft -= 1
...
if audioplaytimerleft <= 0 {
  audio_stop_sound(snd_k9_footsteps)
  global.k9footstep_cam5lvl2 = false
  }}
