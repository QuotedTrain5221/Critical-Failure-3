...
if global.current_zone = global.k9lvl3pos+1{ 
...
if jump_scare_timer = 0{
	...
	if global.k9lvl3pos = 7 and global.door_right_open{
	alarm[1] = 2
	}
	if global.k9lvl3pos = 7 and !global.door_right_open{
		alarm[4] = 2;
	...
	if global.k9lvl3pos = 2 and global.door_left_open{
	alarm[1] = 2
	}
	if global.k9lvl3pos = 7 and !global.door_left_open{
		alarm[4] = 2;
	alarm[3] = 2
	jump_scare_timer = 350
	killstate = false
...
if dead = true{
	...
	if instance_exists(obj_jump_scare_zone){
	    instance_create_layer(obj_jump_scare_zone.x,obj_jump_scare_zone.y,"Instances",obj_k9_jump_scare)
			...
			if dead = true {scr_change_camera_lvl3("jumpscarezone")};
}
