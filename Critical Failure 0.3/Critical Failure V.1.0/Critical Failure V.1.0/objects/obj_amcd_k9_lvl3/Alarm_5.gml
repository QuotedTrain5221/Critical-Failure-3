...
if  global.k9lvl3pos= 1 { //cam 1
    alarm[0] = 2;
	
	
		if forward and pickedadirection {
		alarm[4] = 2;
		global.k9footstep_cam5lvl3 = true
		global.k9lvl3pos= 5;
		...
		instance_create_layer(obj_cam_zone_5_lvl3.x,obj_cam_zone_5_lvl3.y,"Instances",obj_cam_zone_5_k9)
		...
		if instance_exists(obj_cam_zone_1_k9){
			instance_create_layer(obj_cam_zone_1_k9.x,obj_cam_zone_1_k9.y,"Instances",obj_cam_zone_1_lvl3) 
		...
		if !forward and pickedadirection {
		alarm[4] = 2;
		global.k9footstep_cam2lvl3 = true
		global.k9lvl3pos= 2;
		pickedadirection = false
		...
		instance_create_layer(obj_cam_zone_2_lvl3.x,obj_cam_zone_2_lvl3.y,"Instances",obj_cam_zone_2_k9)
...
// Zone 2 move options
   if global.k9lvl3pos= 2{
	   alarm[0] = 2
	       audio_play_sound(snd_left_hallway,1,false)
	   if !global.k9lvl3pos= 2{audio_stop_sound(snd_left_hallway)}
    if forward and pickedadirection{
	if global.door_left_open{
	   ...
	   if instance_exists(obj_cam_zone_5_gwiber){
		...
		if instance_exists(obj_cam_zone_2_k9){
			instance_create_layer(obj_cam_zone_2_k9.x,obj_cam_zone_2_k9.y,"Instances",obj_cam_zone_2_lvl3) 
    ...
    if !forward and pickedadirection{
	   ...
	   pickedadirection = false
        ...
        show_debug_message(amcd_name + " moved zone " + string(global.k9lvl3pos))}

  
// Zone 5 move options

   if global.k9lvl3pos= 5 { //cam 5
    alarm[0] = 2;
	...
	if corridordirection = 1 and pickedadirection {
		alarm[4] = 2;
		global.k9footstep_cam1lvl3 = true
		global.k9lvl3pos= 1;
		pickedadirection = false
		...
		instance_create_layer(obj_cam_zone_1_lvl3.x,obj_cam_zone_1_lvl3.y,"Instances",obj_cam_zone_1_k9)
		...
		if instance_exists(obj_cam_zone_5_k9){
			instance_create_layer(obj_cam_zone_5_k9.x,obj_cam_zone_5_k9.y,"Instances",obj_cam_zone_5_lvl3) 
	...
	if corridordirection = 2 and pickedadirection{
		alarm[4] = 2;
		global.k9footstep_cam6lvl3 = true
		global.k9lvl3pos= 6;
		pickedadirection = false
	   ...
	   if instance_exists(obj_cam_zone_6_prototype){
		...
		if instance_exists(obj_cam_zone_6_lvl3){
		instance_create_layer(obj_cam_zone_6_lvl3.x,obj_cam_zone_6_lvl3.y,"Instances",obj_cam_zone_6_k9)
		instance_destroy(obj_cam_zone_6_lvl3)
		}
...
if global.k9lvl3pos= 6 { //cam 6
	...
	if !forward and pickedadirection{
		alarm[4] = 2;
		global.k9footstep_cam7lvl3 = true
		global.k9lvl3pos= 7;
		pickedadirection = false
		...
		instance_create_layer(obj_cam_zone_7_lvl3.x,obj_cam_zone_7_lvl3.y,"Instances",obj_cam_zone_7_k9)
		...
		if instance_exists(obj_cam_zone_6_k9){
			instance_create_layer(obj_cam_zone_6_k9.x,obj_cam_zone_6_k9.y,"Instances",obj_cam_zone_6_lvl3) 
...
// Zone 7 move options
   if global.k9lvl3pos= 7{
	   alarm[0] = 2
	       audio_play_sound(snd_right_hallway,1,false)
	   if !global.k9lvl3pos= 7{audio_stop_sound(snd_right_hallway)}
    if forward and pickedadirection{
    ...
    if !forward and pickedadirection{
	   ...
	   if instance_exists(obj_cam_zone_5_prototype){
        ...
        show_debug_message(amcd_name + "Moved to Zone " + string(global.k9lvl3pos))};