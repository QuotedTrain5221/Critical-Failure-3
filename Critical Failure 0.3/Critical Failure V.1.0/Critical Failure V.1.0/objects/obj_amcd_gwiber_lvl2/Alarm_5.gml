...
if  global.gwiberlvl2pos = 1 { //cam 1
    alarm[0] = 2;
		...
		if forward and pickedadirection {
		alarm[4] = 2;
		global.gwiberlvl2pos = choose(2,12);
		pickedadirection = false
		...
		if global.gwiberlvl2pos = 12{
			
		if instance_exists(obj_cam_zone_12_lvl2){
		instance_create_layer(obj_cam_zone_12_lvl2.x,obj_cam_zone_12_lvl2.y,"Instances",obj_cam_zone_12_gwiber)
		instance_destroy(obj_cam_zone_12_lvl2)}
...
if global.gwiberlvl2pos = 4 { //cam 4
	...
	if !forward and pickedadirection{
		...
		pickedadirection = false
		if instance_exists(obj_cam_zone_13_lvl2){
		instance_create_layer(obj_cam_zone_13_lvl2.x,obj_cam_zone_13_lvl2.y,"Instances",obj_cam_zone_13_gwiber)
			instance_destroy(obj_cam_zone_13_lvl2)}
	...
	if global.door_left_open{
	  ...
	  global.gwiberkillstate = true
	   ...
	   if instance_exists(obj_cam_zone_1_k9){
		...
		instance_create_layer(obj_cam_zone_1_lvl2.x,obj_cam_zone_2_lvl2.y,"Instances",obj_cam_zone_1_gwiber)
		...
		if instance_exists(obj_cam_zone_2_gwiber){
			instance_create_layer(obj_cam_zone_2_gwiber.x,obj_cam_zone_2_gwiber.y,"Instances",obj_cam_zone_2_lvl2) 
...
// Zone 5 move options
   ...
   if global.gwiberlvl2pos = 5 { //cam 5
	...
	if instance_exists(obj_cam_zone_1_k9){
		...
		if instance_exists(obj_cam_zone_1_lvl2){
		instance_create_layer(obj_cam_zone_1_lvl2.x,obj_cam_zone_1_lvl2.y,"Instances",obj_cam_zone_1_gwiber)
		instance_destroy(obj_cam_zone_1_lvl2)}
		...
		instance_create_layer(obj_cam_zone_5_gwiber.x,obj_cam_zone_5_gwiber.y,"Instances",obj_cam_zone_5_lvl2)
	...
	if !forward and pickedadirection{
		...
		if instance_exists(obj_cam_zone_13_gwiber){
			instance_create_layer(obj_cam_zone_13_gwiber.x,obj_cam_zone_13_gwiber.y,"Instances",obj_cam_zone_13_lvl2) 
   ...
   if	global.gwiberlvl2pos = 12 { //cam 12
	...
	if !forward and pickedadirection{
		...
		if instance_exists(obj_cam_zone_12_gwiber){
			instance_create_layer(obj_cam_zone_12_gwiber.x,obj_cam_zone_12_gwiber.y,"Instances",obj_cam_zone_12_lvl2) 
