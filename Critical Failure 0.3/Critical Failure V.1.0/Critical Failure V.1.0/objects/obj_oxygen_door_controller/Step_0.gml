...
// Doors
open_count   += global.door_left_open  ? 3 : 0;
open_count   += global.door_right_open ? 3 : 0;
closed_count += global.door_left_open  ? 0 : 3;
closed_count += global.door_right_open ? 0 : 3;

// Vents
open_count   += global.vent_front_open ? 3 : 0;
open_count   += global.vent_back_open  ? 3 : 0;
closed_count += global.vent_front_open ? 0 : 3;
closed_count += global.vent_back_open  ? 0 : 3;
