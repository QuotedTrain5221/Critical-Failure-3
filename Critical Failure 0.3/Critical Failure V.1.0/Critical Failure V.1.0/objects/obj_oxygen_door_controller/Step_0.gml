...
if (instance_exists(front_vent_upclose))
    front_vent_upclose.sprite_index = global.vent_front_open ? spr_front_vent_open : spr_front_vent_closed;

if (instance_exists(back_vent_upclose))
    back_vent_upclose.sprite_index = global.vent_back_open ? spr_back_vent_open : spr_back_vent_closed;

//Oxygen calculation
var delta = delta_time / 1000000; //seconds

//Count closed/open doors/vents
var open_count = 0;
var closed_count = 0;
