...
//if (instance_exists(main_left_door))
 //   main_left_door.sprite_index =
 ///   global.door_left_closed ? spr_door_closed_left : spr_left_door_closed_up_close
...
//if (instance_exists(main_right_door))
 //   main_right_door.sprite_index =
 //   global.door_right_closed ? spr_door_closed_right : spr_right_door_closed_up_close;

//if (instance_exists(upclose_right_door))
  //  upclose_right_door.sprite_index =
  //  global.door_right_open ? spr_right_door_closed_up_close : spr_door_closed_right;
