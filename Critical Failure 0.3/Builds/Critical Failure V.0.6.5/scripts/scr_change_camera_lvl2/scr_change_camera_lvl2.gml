function scr_change_camera_lvl2(zone_name)
{
    switch (zone_name)
    {
        ...
        case "lvl2cam12":      global.current_zone = 14; break;
        case "lvl2cam13":      global.current_zone = 15; break;
		case "lvl2cam14":      global.current_zone = 16; break;
	    case "lvl2backVent":   global.current_zone = 17; break;
        case "lvl2frontVent":  global.current_zone = 18; break;
        case "lvl2leftDoor":   global.current_zone = 19; break;
        case "lvl2rightDoor":  global.current_zone = 20; break;
        default:
