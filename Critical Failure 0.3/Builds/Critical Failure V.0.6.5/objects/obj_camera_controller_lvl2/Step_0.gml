...
if (mouse_check_button_pressed(mb_left))
{
    ...
    if (position_meeting(mx, my, obj_cam_1)) scr_change_camera_lvl2("lvl2cam1");
    else if (position_meeting(mx, my, obj_cam_2)) scr_change_camera_lvl2("lvl2cam2");
    else if (position_meeting(mx, my, obj_cam_3)) scr_change_camera_lvl2("lvl2cam3");
    else if (position_meeting(mx, my, obj_cam_4)) scr_change_camera_lvl2("lvl2cam4");
    else if (position_meeting(mx, my, obj_cam_5)) scr_change_camera_lvl2("lvl2cam5");
    else if (position_meeting(mx, my, obj_cam_6)) scr_change_camera_lvl2("lvl2cam6");
    else if (position_meeting(mx, my, obj_cam_7)) scr_change_camera_lvl2("lvl2cam7");
    else if (position_meeting(mx, my, obj_cam_8)) scr_change_camera_lvl2("lvl2cam8");
